          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200 p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-semibold text-blue-900">Restaurant-Specific Webhooks</p>
                  <p className="text-blue-700 text-sm">All webhook tests from this interface will only include data from your restaurant. For security reasons, you cannot send webhooks on behalf of other restaurants.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-sm text-gray-600">
                    Common webhook events you can test: <span className="font-mono bg-gray-100 px-1 rounded">order.placed</span>, <span className="font-mono bg-gray-100 px-1 rounded">order.updated</span>, <span className="font-mono bg-gray-100 px-1 rounded">payment.success</span>
                  </p>
                </div>
              </div>
            </div>
...
export default PartnerWebhookTester;