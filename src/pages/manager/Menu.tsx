      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="text-gray-600">Add and edit menu items (deletion requires owner approval)</p>
          </div>
        ...
        <motion.div variants={itemVariants}>
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-200 p-4">
            <div className="flex items-start space-x-3">
              <AlertTriangle className="h-5 w-5 text-blue-500 mt-0.5" />
              <div className="text-sm">
                <p className="font-semibold text-blue-900">Manager Permissions</p>
                <p className="text-blue-700">You can add and edit menu items. Category deletion requires owner approval.</p>
              </div>
            </div>
          </div>
        </motion.div>
