                ...
                return (
                  ...
                  >
                    ...
                    {order.priority !== 'normal' && (
                      <motion.div
                        animate={order.priority === 'urgent' ? { scale: [1, 1.1, 1] } : {}}
                        transition={{ duration: 1, repeat: Infinity }}
                        className={`absolute top-4 right-4 ${priorityConfig.bg} ${priorityConfig.color} px-2 py-1 rounded-full text-xs font-medium flex items-center space-x-1`}
                      >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        <div className={`p-3 bg-gradient-to-br ${statusConfig.color.includes('blue') ? 'from-blue-500 to-cyan-500' : statusConfig.color.includes('yellow') ? 'from-yellow-500 to-amber-500' : statusConfig.color.includes('green') ? 'from-green-500 to-emerald-500' : 'from-purple-500 to-violet-500'} rounded-xl shadow-lg`}>
