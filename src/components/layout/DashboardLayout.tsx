...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    { 
      ...
      badge: null,
      permission: { feature: 'dashboard', permission: 'read' as const }
    },
    { 
      name: 'Orders', 
      href: '/partner/orders', 
      icon: ShoppingBag, 
      badge: '3',
      permission: { feature: 'orders', permission: 'read' as const }
    },
    { 
      name: 'Menu', 
      href: '/partner/menu', 
      icon: MenuIcon, 
      badge: null,
      permission: { feature: 'menu', permission: 'read' as const }
    },
    { 
      name: 'Tables', 
      href: '/partner/tables', 
      ...
      badge: null,
      permission: { feature: 'tables', permission: 'read' as const }
    },
    { 
      name: 'Analytics', 
    ...
    { 
      ...
      icon: CreditCard, 
      badge: null,
      permission: { feature: 'pos', permission: 'read' as const }
    },
    { 
      name: 'CRM', 
      href: '/partner/crm', 
    ...
    { 
      ...
      icon: Crown, 
      badge: null,
      permission: { feature: 'subscription', permission: 'read' as const }
    },
    { 
      name: 'Webhook Tester', 
      href: '/partner/integrations/webhook-tester', 
      icon: Globe, 
      badge: null,
      permission: { feature: 'dashboard', permission: 'read' as const }
    },
    { 
      ...
      icon: Settings, 
      badge: null,
      permission: { feature: 'branding', permission: 'read' as const }
    },
  ];
      ...
      >
        ...
        <div className="p-4 flex-shrink-0">
          <motion.div
            ...
            className="bg-gradient-to-r from-success-50 to-green-50 p-4 rounded-xl border border-success-200"
          >
            <div className="flex items-center space-x-3">
              <motion.div
              ...
              />
              <div>
                <p className="text-sm font-medium text-success-800">System Online</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              {user.restaurantName && (
                <div className="hidden md:block text-right">
                  ...
                  <p className="text-xs text-gray-500">12 tables • 3 active orders</p>
                </div>
              )}
            </div>
          </div>
